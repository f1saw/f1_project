                    ...
                    <div id="num<?php echo $i ?>">
                        ...
                        <div class="card-body d-flex align-items-end">
                            <div class="w-100">
                                ...
                                <hr>
                                <p><strong>National: </strong><img style="position: relative; left:75px; height: 20px; width: 30px" src="<?php echo $flag_list[$i] ?>" alt="Flag picture."></p>
                                <p><strong>Number: </strong><img style="position: relative; left:70px; height: 20px; width: 40px" src="<?php echo $number_list[$i] ?>" alt="Number picture."></p>
                                <hr>
                                <button style="position: relative; left: 28px" type="button" onclick="f1_scrape_info_drivers('<?php echo $i ?>', '<?php echo $json_info_link[$i]["URL"] ?>')" class="btn card-link text-decoration-none d-flex flex-row justify-content-end">
