                    ...
                    <div id="num<?php echo $i ?>">
                        ...
                        <div class="card-body d-flex align-items-end">
                            <div class="w-100">
                                ...
                                <hr>
                                <p class="d-flex justify-content-between"><strong>National: </strong><img style="position: relative; height: 20px; width: 30px" src="<?php echo $flag_list[$i] ?>" alt="..."></p>
                                <p class="d-flex justify-content-between"><strong>Number: </strong><img style="position: relative; left:4px; height: 20px; width: 40px" src="<?php echo $number_list[$i] ?>" alt="..."></p>
                                <hr id="hr<?php echo $i; ?>">
